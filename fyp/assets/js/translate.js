...
uploadBtn.addEventListener('click', function () {
    uploadBtn.style.background = "rgba(130, 86, 98, 0.77)";
...
cameraBtn.addEventListener("click", function () {
    if (cameraBtn.style.backgroundColor === 'rgb(212, 236, 126)') {
        cameraBtn.style.background = "rgba(130, 86, 98, 0.77)"; //deactivate btn
        alert('stopping... Press OK')
        location.reload()

    } else {
        cameraBtn.style.background = "rgba(130, 86, 98, 0.77)";
...
gttsBtn.addEventListener("click", function () {
    if (gttsBtn.style.backgroundColor === 'rgba(130, 86, 98, 0.77)') {
        gttsBtn.style.background = "rgba(130, 86, 98, 0.77)"; //dactivate btn
        // alert('stopping... Press OK')
        // location.reload()

    } else {
        gttsBtn.style.background = "rgba(130, 86, 98, 0.77)";
        // alert('starting.... Press OK')
        // init();
    }
});
...
async function init() {
   const modelURL="https://teachablemachine.withgoogle.com/models/Vf3pXh-Fc/model.json"
   const metadataURL="https://teachablemachine.withgoogle.com/models/Vf3pXh-Fc/"
